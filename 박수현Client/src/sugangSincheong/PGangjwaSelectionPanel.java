...
public class PGangjwaSelectionPanel extends JTable {
	...
	public void intialize(String hakgwaFileName, PResultPanel pMiridamgiPanel, PResultPanel pSincheongPanel) throws RemoteException, NotBoundException {
	...
	public void update(String hakgwaFileName) throws RemoteException, NotBoundException {
	...
	public void update() throws RemoteException, NotBoundException {
