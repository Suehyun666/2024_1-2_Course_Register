...
public class PSelectionPanel extends PGangjwaContainer {
	...
	public void initialize(PResultPanel pMiridamgiPanel, PResultPanel pSincheongPanel) throws Exception {
	...
	public void addGangjwas(Vector<VGangjwa> vSelectedGangjwas) throws Exception {
